...
class CUB200(DS):
  ...
  def prepare_data(self): 
    self.data_train, self.labels_train = DL.load_directory_as_dataset(self.extracted_files + '/CUB_200_2011/images/', (100, 100, 3), reshape=True, max_classes=self.num_classes)
